...
export const vi: Translations = {
  ...
  v2: {
    platform: {
      ...
      pillars: {
        ...
        aiLiteracy: {
          ...
          description: 'Chương trình K-12 được VNIES chứng nhận cùng khóa học AI đại học — triển khai toàn trường.',
        },
      },
      tools: {
    ...
    programs: {
      ...
      k12: {
        badge: 'Đã được VNIES chứng nhận',
        title: 'Học Cùng AI \u2014 Chương trình Giáo dục AI K-12',
        subtitle: 'Một trong những chương trình giáo dục AI được chứng nhận sớm nhất tại Việt Nam',
        description: 'Khung chương trình giáo dục AI toàn diện, đã chứng nhận, bao phủ lớp 1\u201312. Học sinh làm chủ AI qua các hoạt động thực hành trên năm lĩnh vực năng lực \u2014 phù hợp Chương trình GDPT 2018.',
        certifiedBy: 'Chứng nhận bởi',
        certifier: 'Viện Khoa Học Giáo Dục Việt Nam (VNIES)',
        grades: 'Cấp học',
        gradesValue: 'Tiểu học (1\u20135) \u00B7 THCS (6\u20139) \u00B7 THPT (10\u201312)',
        domains: 'Năng lực cốt lõi',
        domainsValue: 'Hiểu biết \u00B7 Ứng dụng \u00B7 Tư duy phản biện \u00B7 Đạo đức \u00B7 Sáng tạo',
