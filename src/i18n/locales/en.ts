...
export const en: Translations = {
  ...
  programs: {
    ...
    k12: {
      ...
      description: 'A certified AI literacy framework helping students master AI through hands-on activities. Covers understanding, applying, critical thinking, ethics, and creativity — aligned with the UNESCO AI Competency Framework and Vietnam\'s national curriculum.',
      certifiedBy: 'Accreditation & alignment',
      certifier: 'VNIES (Vietnam Institute of Educational Sciences) · Aligned with UNESCO AI Competency Framework',
      grades: 'Grade levels',
  ...
  v2: {
    platform: {
      ...
      pillars: {
        ...
        aiLiteracy: {
          ...
          description: 'Nationally certified K-12 curriculum aligned with UNESCO AI standards, plus university AI courses — deploy schoolwide.',
        },
      },
      tools: {
    ...
    programs: {
      ...
      k12: {
        badge: 'Nationally Certified',
        title: 'H\u1ECDc C\u00F9ng AI \u2014 K-12 AI Curriculum',
        subtitle: 'Certified AI literacy program aligned with international standards',
        description: 'A complete AI literacy framework covering Grades 1\u201312. Students master AI through hands-on activities across five competency domains \u2014 aligned with the UNESCO AI Competency Framework and Vietnam\'s national curriculum (GDPT 2018).',
        certifiedBy: 'Accreditation & alignment',
        certifier: 'VNIES (Vietnam Institute of Educational Sciences) \u00B7 Aligned with UNESCO AI Competency Framework',
        grades: 'Grade levels',
        gradesValue: 'Elementary (1\u20135) \u00B7 Middle (6\u20139) \u00B7 High (10\u201312)',
